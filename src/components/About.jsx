        ...
        <Row style={{ marginBottom: "50px" }}>
          ...
          <Col lg={6}>
            ...
            <p className="techx-overview-text text-justify">
              TechXcelerate, launched in April 2023, is a series of interactive
              sessions designed to empower first and second-year students with
              essential technical skills. These beginner-friendly sessions cover
              a wide range of topics, including Competitive Programming, web
              development, app development, data science, and more. Delivered by
              industry-leading professionals, TechXcelerate aims to provide
              students with the tips and tricks necessary to excel in various
              technical domains.
            </p>
        ...
        <Row>
          <Col lg={6}>
            ...
            <p className="techx-overview-text text-justify">
              ...
              of the largest technical communities in Delhi-NCR and is racing
              towards further expansion and deeper penetration in its core
              segments.
            </p>
            <div className="counters-grid">
          ...
          <Col lg={6}>
            ...
            >
              <video
                ...
                muted
              >
                <source src={nameSpaceVideo} type="video/mp4" />
              </video>
            </div>
          </Col>
        </Row>
